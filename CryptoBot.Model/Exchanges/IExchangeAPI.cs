...
namespace CryptoBot.ExchangeEngine.API.Exchanges
{
    ...
    public interface IExchangeApi
    {
        ...
        /// <returns></returns>
        Ticker GetTicker(Coin baseCoin, Coin coin);
        ...
        Task<Ticker> GetTickerAsync(Coin baseCoin, Coin coin);

        /// <summary>
        /// Get all tickers, not all exchanges support this
        /// </summary>
        /// <returns>Key value pair of symbol and tickers array</returns>
        IEnumerable<KeyValuePair<string, Ticker>> GetTickers();

        /// <summary>
        /// ASYNC - Get all tickers, not all exchanges support this
        /// </summary>
        /// <returns>Key value pair of symbol and tickers array</returns>
        Task<IEnumerable<KeyValuePair<string, Ticker>>> GetTickersAsync();
        ...
        ExchangeOrderBook GetOrderBook(Coin baseCoin, Coin coin, int maxCount = 100);
        ...
        /// <param name="maxCount">Max count of bids and asks - not all exchanges will honor this parameter</param>
        /// <returns>Orders</returns>
        Task<ExchangeOrderBook> GetOrderBookAsync(Coin baseCoin, Coin coin, int maxCount = 100);
        ...
        IEnumerable<Trade> GetHistoricalTrades(Coin baseCoin, Coin coin, DateTime? sinceDateTime = null);
        ...
        /// <param name="sinceDateTime">Since date time</param>
        /// <returns>Trades</returns>
        Task<IEnumerable<Trade>> GetHistoricalTradesAsync(Coin baseCoin, Coin coin, DateTime? sinceDateTime = null);
        ...
        /// <param name="symbol">Symbol</param>
        /// <returns>Trades</returns>
        IEnumerable<Trade> GetRecentTrades(Coin baseCoin, Coin coin);
        ...
        /// <param name="symbol">Symbol</param>
        /// <returns>Trades</returns>
        Task<IEnumerable<Trade>> GetRecentTradesAsync(Coin baseCoin, Coin coin);
        ...
        IEnumerable<Candle> GetCandles(Coin baseCoin, Coin coin, int periodSeconds, DateTime? startDate = null, DateTime? endDate = null);
        ...
        /// <param name="endDate">Optional end date to get candles for</param>
        /// <returns>Candles</returns>
        Task<IEnumerable<Candle>> GetCandlesAsync(Coin baseCoin, Coin coin, int periodSeconds, DateTime? startDate = null, DateTime? endDate = null);
        ...
        /// <param name="quantity">Amount to buy or sell</param>
        /// <param name="price">Price to buy or sell at</param>
        /// <param name="buy">True to buy, false to sell</param>
        /// <param name="type">Order type, stop, limit, market etc</param>
        /// <returns>Order result and message string if any</returns>
        ExchangeOrderResult PlaceOrder(Coin baseCoin, Coin coin, decimal quantity, decimal? price, bool buy, Enumerations.OrderTypeEnum type);
        ...
        /// <returns>Order result and message string if any</returns>
        Task<ExchangeOrderResult> PlaceOrderAsync(Coin baseCoin, Coin coin, decimal amount, decimal price, bool buy);
        ...
        IEnumerable<ExchangeOrderResult> GetOpenOrderDetails(Coin baseCoin = null, Coin coin = null);
        ...
        /// <param name="symbol">Symbol to get open orders for or null for all</param>
        /// <returns>All open order details for the specified symbol</returns>
        Task<IEnumerable<ExchangeOrderResult>> GetOpenOrderDetailsAsync(Coin baseCoin = null, Coin coin = null);
        ...
        /// <summary>
        /// Gets if this exchange is simulated
        /// </summary>
        bool Simulated { get; }
    }
}
