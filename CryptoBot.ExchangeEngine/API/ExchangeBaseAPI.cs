...
namespace CryptoBot.ExchangeEngine.API
{
    /// <summary>
    ...
    /// </summary>
    public abstract class ExchangeBaseAPI
    {
        /// <summary>
        ...
        /// </summary>
        public RateGate RateLimit { get; set; } = new RateGate(3, TimeSpan.FromSeconds(1d));
        ...
        /// </summary>
        public string RequestUserAgent { get; set; } = "CryptoBot"; // "ExchangeSharp (https://github.com/jjxtra/ExchangeSharp)";
